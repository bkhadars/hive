...
require (
	...
	sigs.k8s.io/cluster-api-provider-aws/v2 v2.4.1-0.20240306201835-baf8d59ff495 // indirect
...
require (
	...
	sigs.k8s.io/cluster-api-provider-azure v1.13.0 // indirect
	sigs.k8s.io/cluster-api-provider-openstack v0.9.0 // indirect
	sigs.k8s.io/cluster-api-provider-vsphere v1.9.0 // indirect
